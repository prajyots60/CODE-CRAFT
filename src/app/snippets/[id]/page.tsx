...
const SnippetDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main
      className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12"
      >
        <div className="max-w-[1200px] mx-auto">
          {/* Header */}
          <div className="bg-[#121218] border border-[#ffffff0a] rounded-2xl p-4 sm:p-6 mb-6 backdrop-blur-xl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              <div className="flex items-center gap-4">
                <div className="flex items-center justify-center size-12 rounded-xl bg-[#ffffff08] p-2.5">
                  <Image src={`/${snippet.language}.png`} alt= {`${snippet.language}.logo`} width={24} height={24} className="w-full h-full object-contain" />
                </div>
                <div>
